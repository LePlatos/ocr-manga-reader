...
public class SDTextBrowserActivity extends TabActivity
{
  ...
  private void changeDirectory(File directory)
  {
    ...
    browserListView.setAdapter(new ListAdapter(SDTextBrowserActivity.this, directory, R.layout.sd_item_empty));
  }
      ...
      case NO_SD:
        return new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_menu_info_details)
            ...
            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener()
            {
              ...
              {
                SDTextBrowserActivity.this.setResult(RESULT_CANCELED);
                SDTextBrowserActivity.this.finish();
              }
            }).create();
    }
    return null;
  ...
  // HistoryManager.getInstance(SDTextBrowserActivity.this).getRecentFiles();
